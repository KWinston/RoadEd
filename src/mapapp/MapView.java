...
//        wms.setLayer();
    ...
    public void goChicago() {
        ...
        jXMapKit1.setAddressLocation(new GeoPosition(53.5004700019755, -113.620436138047 ));
    }
    ...
    @org.jdesktop.application.Action
    public void addWaypoint() throws FileNotFoundException {
        File file = new File("/plotData.txt");
        Scanner input = new Scanner(file);
        Set<Waypoint> waypoints = new HashSet<Waypoint>();
        while (input.hasNext()) {
            waypoints.add(new Waypoint(Double.parseDouble(input.next()), Double.parseDouble(input.next())));
        }
        waypoints.addAll(pinList);
        System.out.println("Check WP: " + waypoints.toString());
        //for (int i=0; i < 500; i++) {
